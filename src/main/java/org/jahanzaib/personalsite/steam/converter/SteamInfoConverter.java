...
public class SteamInfoConverter {
    private static final String STEAM_IMAGE_URL =
            "https://media.steampowered.com/steamcommunity/public/images/apps/{appId}/{imgIconId}.jpg";
        ...
        for (SteamGameDTO game : games) {
            var imageUrl =
                    STEAM_IMAGE_URL
                            ...
                            .replace("{imgIconId}", game.img_icon_url());
